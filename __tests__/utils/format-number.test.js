...
describe('formatNumber', () => {
  test('should append ANON in balance amount', () => {
    const myBalance = formatNumber({ value: 2.5, append: 'ANON ' });

    const expectedState = 'ANON 2.5';

    expect(myBalance).toEqual(expectedState);
  });

  test('should multiply ANON balance and show it in USD', () => {
  ...
  test('should multiply decimal ANON balance and show it in USD', () => {
    const myBalanceInUsd = formatNumber({
