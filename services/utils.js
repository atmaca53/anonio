...
export type APIMethods = {
  ...
  verifymessage: (anonaddress: string, signature: string, message: string) => Promise<boolean>,
  z_validateaddress: (
    zaddr: string,
  ) => Promise<{
    isvalid: boolean,
  ...
  getaccount: (anonaddress: string) => Promise<string>,
  ...
  getreceivedbyaddress: (anonaddress: string, minconf?: number) => Promise<number>,
  gettransaction: (
    txid: string,
  ...
  importprivkey: (anonprivkey: string, label?: string, rescan?: boolean) => Promise<void>,
  ...
  setaccount: (anonaddress: string, account: string) => Promise<void>,
