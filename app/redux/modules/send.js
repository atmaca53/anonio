...
export const LOAD_ANON_PRICE = 'LOAD_ANON_PRICE';
...
export const loadANONPrice = ({ value }: { value: number }) => ({
  type: LOAD_ANON_PRICE,
  payload: {
    value,
  },
});
...
export default (state: State = initialState, action: Action): State => {
  switch (action.type) {
    ...
    case LOAD_ANON_PRICE:
      return { ...state, anonPrice: action.payload.value };
