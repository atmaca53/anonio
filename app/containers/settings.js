...
import { ANON_NETWORK } from '../constants/anon-network';
...
export type MapDispatchToProps = {|
  ...
  updateAnonNetwork: (newNetwork: string) => void,
|};
...
const mapDispatchToProps = (dispatch: Dispatch): MapDispatchToProps => ({
  ...
  updateAnonNetwork: (newNetwork) => {
    electronStore.set(ANON_NETWORK, newNetwork);
